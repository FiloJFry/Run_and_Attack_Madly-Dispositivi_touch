...
function Gioco(Protagonista,ShotgunEquipaggiato,AssaltoEquipaggiato,CecchinoEquipaggiato,MischiaEquipaggiata,NemicoScelto,DatiDiPosizione)
{
    ...
    BottoneMischia.addEventListener('click', (event) => {event.stopPropagation(); BottoneMischia.style.opacity = "1"; setTimeout(() => {BottoneMischia.style.opacity = "0.5"},100); if(!DatiDiPosizione.InPausa){
    ...
    BottoneShotgun.addEventListener('click',(event) => {event.stopPropagation(); BottoneShotgun.style.opacity = "1"; setTimeout(() => {BottoneShotgun.style.opacity = "0.5"},100);  if(!DatiDiPosizione.InPausa){
    ...
    BottoneAssalto.addEventListener('click',(event) => {event.stopPropagation(); BottoneAssalto.style.opacity = "1"; setTimeout(() => {BottoneAssalto.style.opacity = "0.5"},100);  if(!DatiDiPosizione.InPausa){
    ...
    BottoneCecchino.addEventListener('click',(event) => {event.stopPropagation(); BottoneCecchino.style.opacity = "1"; setTimeout(() => {BottoneCecchino.style.opacity = "0.5"},100);  if(!DatiDiPosizione.InPausa){
    ...
    BottoneRicarica.addEventListener('click',(event) => {event.stopPropagation(); BottoneRicarica.style.opacity = "1"; setTimeout(() => {BottoneRicarica.style.opacity = "0.5"},100);  if(!DatiDiPosizione.InPausa){
            if(ArmaPresa != MischiaEquipaggiata && !InCarica)
            {   
                InCarica = true;
                ArmaPresa.Ricarica();
    ...
    BottoneSchiva.addEventListener('click',(event) => {event.stopPropagation(); BottoneSchiva.style.opacity = "1"; setTimeout(() => {BottoneSchiva.style.opacity = "0.5"},100); if(!DatiDiPosizione.InPausa){
    ...
    BottoneMuoviSu.addEventListener('touchstart',(event) => {if(Fattibile){if(event.touches.length >= 2){Fattibile = false;} BottoneMuoviSu.style.opacity = "1"; if(!DatiDiPosizione.InPausa){
    ...
    BottoneMuoviGiù.addEventListener('touchstart',(event) => {if(Fattibile){if(event.touches.length >= 2){Fattibile = false;} BottoneMuoviGiù.style.opacity = "1"; if(!DatiDiPosizione.InPausa){
                if(!DatiDiPosizione.Corri)
                {
                    ArmaInCanna.classList.add('shake');
                    DatiDiPosizione.Corri = true;
