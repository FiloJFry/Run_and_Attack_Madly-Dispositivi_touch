...
const LanciafiammeTriforcuto = new Arma("Lanciafiamme triforcuto",4000,16,5,20,1,true,"^ ^ ^",["FFFSH", "", "blblblbl..."]);
const DistributoreDiPalline = new Arma("Distributore di palline",196,75,45,180,15,true,"I<br/>==O==<br/>I",["Boing!", "tk", "CRT-CRT-CRT"]);
const SparaOssa = new Arma("Sparaossa",90,84,80,320,75,true,"I<br/>--X--<br/>I",["tln", "tsh!", "frrlll!"]);
const FriggitriceDAssalto = new Arma("Friggitrice da assalto",324,64,30,120,56,true,"I<br/>~~(#)~~<br/>I",["tsn", "ffssh", "zzz"]);
const LanciaMiniRazzi = new Arma("Lanciaminirazzi",384,92,16,64,120,true,"‼<br/>≡≡Ø≡≡<br/>‼",["vsh!", "c-clck", "c-clck"]);
const GeneratoreDaBattaglia = new Arma("Generatore da battaglia",2050,145,8,32,1200,false,"/ <br/>-·-<br/> /",["BZ","bng","clk-c-clk"]);
const LanciaGranateDiPrecisione = new Arma("Lanciagranate di precisione",3840,128,5,20,1800,false,"|<br/>= ᴓ =<br/>|",["fln-BOOM","k-cluk","k-cluk"]);
const ManoAPistola = new Arma("Mano a pistola",1350,168,10,40,500,false,"ɵ",["Pium!","mmmh...","gnam!"]);
const CannoneDiCarroArmato = new Arma("Cannone di carro armato",11800,152,1,4,2500,false,"||<br/>≡≡O≡≡<br/>||",["POM","B-DSH","C-DSH"]);
